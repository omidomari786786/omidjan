#!/usr/bin/python2
#coding=utf-8
#This Script Is Written By Omid Omari
  #=================================#
  #Tech-omid omari The Official Programmrer#   
  #                                 #
  #                                 #
  #=================================#
  ...
  Bones    |      |    ----;' / | \ ;-<--------- Infraorbital Foramen
     ...
     Mandible |      |  \,III I I I III,/  | 
              ...
              |__         \.    ^    ./   
                            ^~~~^~~~^
\033[1;95m╔═━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⌗⊰
\033[1;92m║\033[1;93mAUTHOR ⊱⟡⊰ \033[1;92m Omid Omari
\033[1;92m║\033[1;93mCREATE BY ⊱⟡⊰ \033[1;92m Omid
\033[1;92m║\033[1;93mFACEBOOK ⊱⟡⊰ \033[1;92mhttps://www.facebook.com/profile.php?id=100026411650543      
\033[1;95m╚═━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⌗⊰                        
...
\033[1;93m SUBSCRIBE OUR TELGRAME CHANNEL ✔️
\033[0;33m⚚═╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌═⚚

\033[0;33m⚚═╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌═⚚
\033[0;92mDon't use OLD ACCOUNT TO LOGIN
...
print """
\033[1;32m╔════•ೋೋ•ೋೋ•════════════╗
\033[1;96m  •••@omidafghan786•••
\033[1;32m╚════•ೋೋ•ೋೋ•════════════╝"""
 
jalan('\033[0;33m⚚═╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌═⚚')

jalan('\033[1;97mLoading•••Omid')
jalan('\033[1;97m▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒')
print"\033[1;32m✖⊱⊶⊶⊶⊶⊶⊶⊶⊶⊶⊰✖"
jalan('\033[1;97m█▒▒▒▒▒▒▒▒▒▒▒▒▒▒')
print"\033[1;32m✖⊱⊶⊶⊶⊶⊶⊶⊶⊶⊶⊰✖"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "\033[1;32mLOADING..... " + username #Dev:arman
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;38mPLEASE WAIT"
            os.system('https://www.youtube.com/channel/UCKX5IrKQsIhejUw8ePpvJ-Q')
    else:
        print "\033[1;31mACCESS DENIED"
        os.system('xdg-open https://www.facebook.com/amirkhan.arya')
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://youtu.be/S7FYMBh1GBA)
...
def menu():
	...
	print "\033[1;93mSUBSCRIBES MY YOUTUBE CHANNEL MOHAMMAD HACKER[🚶]"
	
	print "\033[0;33m⚚═╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌═⚚"

	print "\033[1;38m≫ \033[1;34m1.\x1b[1;94mStart Cloning arman ✪"
...
"""
	...
	p.map(main, id)
	print "\033[0;33m⚚═╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌═⚚"
	print "  \033[1;93m⚚═╌╌╌ Developed By Omid Omari╌╌╌═⚚" #Dev:Omid
	print '\033[1;96m✅Process Has Been Completed Press➡ Ctrl+Z.↩ Next Type (python2 Omidjan.py)↩\033[1;97m....'
	print"\033[1;92mTotal OK/\x1b[1;93omCP \033[1;93m: \033[1;97m"+str(len(oks))+"\033[1;97m/\033[1;93m"+str(len(cekpoint))
	print """
